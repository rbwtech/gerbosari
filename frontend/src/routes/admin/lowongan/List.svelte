...
<AdminShell>
  <div class="flex items-start justify-between gap-4 mb-6">
    <div>
      <h1 class="font-serif text-2xl font-semibold text-arang-900">Lowongan Kerja</h1>
      <p class="mt-1 text-sm text-arang-600">Kelola lowongan UMKM, formal, dan freelance warga desa.</p>
    </div>
    <Button href="#/admin/lowongan/new" variant="primary" size="md">Tambah Lowongan</Button>
  </div>
