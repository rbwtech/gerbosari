...
export default {
  ...
  theme: {
    extend: {
      ...
      // No backgroundImage tokens. Section surfaces now resolve to plain
      // solid-color paper tones (krem-50 / menoreh-50 / krem-100 / menoreh-900)
      // applied via the utility classes in app.css. Earlier iterations layered
      // SVG noise + batik dot motifs + radial-gradient blobs but they read as
      // generic AI-generated chrome; dropping them produced cleaner, calmer
      // editorial transitions between sections.
    }
  },
  plugins: []
};
